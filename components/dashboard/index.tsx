                ...
                <Card className="w-full transition-all transform hover:-translate-y-1 duration-200 flex flex-col justify-center h-25 bg-white border-l-4 border-l-blue-500">
                    <div className="flex space-x-5 items-center">
                        ...
                        <div>
                            ...
                            <h1 className="text-2xl font-bold">1,270</h1>
                        </div>
                    </div>
                </Card>
            ...
            <div className="grid grid-cols-2 gap-3">
                <Card className="w-full min-h-60 bg-white">
                    <div className="py-5 px-4">
                        ...
                        <div className="w-full rounded-lg px-3 pt-2 bg-blue-50 min-h-17 mb-2">
                            <div className="flex space-x-3 items-center">
                                <FaClock size={22} className="fill-blue-500" />
                                <div>
                                    <span className="block font-semibold">Pendamping Pagi</span>
                                    <span>07:00 - 08:00 | Kelas X-XII</span>
                                </div>
                            </div>
                        </div>
                        <div className="w-full rounded-lg px-3 pt-2 bg-green-50 min-h-17">
                            <div className="flex space-x-3 items-center">
                                <FaUsers size={22} className="fill-green-500" />
                                <div>
                                    <span className="block font-semibold">Sesi Konseling</span>
                                    <span>14:00 - 16:00 | Ruang BK</span>
                                </div>
                            </div>
                        </div>
                    </div>
